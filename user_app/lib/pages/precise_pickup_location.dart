...
class _PrecisePickUpScreenState extends State<PrecisePickUpScreen> {
  ...
  Future<void> locateUserPosition() async {
    ...
    // Fetch the address for the user's current location
  ...
  Future<void> updatePickupLocationOnMapIdle() async {
    if (pickLocation != null) {
      // Fetch address based on the map's current camera position
      String address = await CommonMethods()
      ...
      setState(() {
        ...
        // Update provider with the updated pickup location
        Provider.of<AppInfo>(context, listen: false)
            .updatePickkUpLocationAddress(userPickUpAddress);
      });
    }
        ...
        children: [
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) {
              ...
              // Locate the user's current position when the map is created
              locateUserPosition();
            },
            ...
            onCameraIdle: () async {
              // Update pickup location when the camera stops moving
              await updatePickupLocationOnMapIdle();
            },
          ),
          Align(
